...
?>
	<a class="bp-fb-profile" href="<?php echo $twcj_username; ?>" class="twitter-follow-button" data-show-count="<?php bp_twitter_member_count(); ?>" <?php if (get_option('twittercj-button-size')==1) echo 'data-size="large""'; ?>><img src="<?php echo $img_url; ?>"/></a>
...
<?php
	...
	{
?>
	<a class="bp-fb-profile" href="<?php echo $gpcj_username; ?>" ><img src="<?php echo $img_url; ?>"/></a>
	<?
		}
		...
		{
	?>
	<a class="bp-fb-profile" href="<?php echo $ptcj_username; ?>" ><img src="<?php echo $img_url; ?>" /></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $licj_username; ?>" ><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $tmcj_username; ?>"><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $incj_username; ?>"><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $flcj_username; ?>" ><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $ytcj_username; ?>" ><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
	...
	{
	?>
	<a class="bp-fb-profile" href="<?php echo $mscj_username; ?>"><img src="<?php echo $img_url; ?>"/></a>
	<?
	}
